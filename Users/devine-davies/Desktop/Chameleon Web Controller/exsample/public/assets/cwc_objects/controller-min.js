...
function cwc_hooks()
{
    ...
    Hooks.set_hook( {
      ...
      method    : function( trailler_name ) {
        show_trailler_buttons( trailler_name );
      }
    });
...
function show_trailler_buttons()
{
...
{
    $('.traille-buttons button').on('click', function(){
        Hooks.invoke({
            hook_name : 'd-hook:video-button-invoked',
            arguments : $( this ).attr('class')
        });
    });

    $('.traille-buttons button.exit').on('click', function(){
